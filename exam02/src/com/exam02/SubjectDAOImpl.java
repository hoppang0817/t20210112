...
//throws Exception : ?Ç¨?ö©?ïò?äîÍ≥≥Ïóê?Ñú ?òà?ô∏Ï≤òÎ¶¨?ïòÍ≤†Îã§.
	@Override
	...
	public List<Subject> selectSubject() throws Exception {
		...
		List<Subject> subjectList = new ArrayList<Subject>();//?†ÑÏ≤? Î™©Î°ù?ùÑ Î≥¥Í??ï† Î≥??àò
		while(rs.next()) {//?ïúÏ§ÑÏî©Í∞??†∏?ò¥
			//subject Í∞ùÏ≤¥ ?Éù?Ñ±
